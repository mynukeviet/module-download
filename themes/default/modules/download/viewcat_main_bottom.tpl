    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="image pull-left">
                <a title="{itemcat.title}" href="{itemcat.more_link}"> <img src="{itemcat.imagesrc}" alt="{itemcat.title}" class="thumbnail" />
                </a>
            </div>
            <!-- END: image -->
            <h3>
                <a title="{itemcat.title}" href="{itemcat.more_link}"><strong>{itemcat.title}</strong></a>
            </h3>
