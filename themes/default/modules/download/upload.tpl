...
<form id="uploadForm" name="uploadForm" action="{FORM_ACTION}" method="post" enctype="multipart/form-data" class="form-horizontal" role="form" data-upload_filetype="{UPLOAD.upload_filetype}">
    <div class="panel panel-default">
        <div class="panel-heading">{LANG.upload}</div>
        <div class="panel-body">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-18 col-md-18">
                    ...
                    <em class="help-block">{LANG.upload_valid_ext_info}: {EXT_ALLOWED}</em> <input type="file" name="upload_fileupload" id="upload_fileupload" style="display: none" />
                </div>
            </div>
            <!-- END: is_upload_allow -->
            ...
            <div class="form-group"{CSS_FILEIMAGE}>
                ...
                <div class="col-lg-18 col-md-18">
                    <div class="input-group">
                        <input type="text" class="form-control{REQ_FILEIMAGE1}" id="photo_name" disabled> <span class="input-group-btn">
                            <button class="btn btn-default" onclick="$('#upload_fileimage').click();" type="button">
                                <em class="fa fa-folder-open-o fa-fix">&nbsp;</em> {LANG.file_selectfile}
                            </button>
                        </span>
                    </div>
                    <em class="help-block">{LANG.upload_valid_ext_info}: jpg, gif, png</em> <input type="file" name="upload_fileimage" id="upload_fileimage" style="display: none" />
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8 col-md-8">
                    <img class="middle captchaImg" height="31" name="upload_vimg" src="{NV_BASE_SITEURL}index.php?scaptcha=captcha&t={NV_CURRENTTIME}" alt="{GLANG.captcha}" /> <img class="middle fa-pointer refresh" alt="{GLANG.captcharefresh}" src="{NV_BASE_SITEURL}{NV_ASSETS_DIR}/images/refresh.png" width="16" height="16" onclick="change_captcha('#upload_seccode_iavim');" />
                </div>
            </div>
            <!-- END: captcha -->
            <!-- BEGIN: recaptcha -->
            ...
            <div class="form-group">
                <label class="col-sm-6 col-md-6 control-label"></label>
                <div class="col-sm-18 col-md-18 text-center">
                    <input type="hidden" name="addfile" value="{UPLOAD.addfile}" /> <input class="btn btn-primary" type="submit" name="submit" value="{LANG.upload}" />
                </div>
            </div>
        </div>
    </div>
...
<!-- END: main -->
<!-- BEGIN: cat -->
<li class="list-group-item upload-catlist-item list-group-item-info"><strong>{PARENT_TEXT}</strong></li>
<!-- BEGIN: loop -->
<li class="list-group-item upload-catlist-item"><input type="radio" name="upload_catid" id="upload_catid_{CAT.id}" value="{CAT.id}" {CAT.checked}/>&nbsp;<label for="upload_catid_{CAT.id}">{CAT.title}</label>
    <div class="pull-right">
        <!-- BEGIN: loadparentcat -->
        <a href="#" data-toggle="upcatload" data-catid="{CATID}" data-parentid="{PARENTID}" data-tokend="{NV_CHECK_SESSION}" title="{LANG.load_parentcat}"><i class="fa fa-arrow-circle-left" aria-hidden="true"></i></a>
        <!-- END: loadparentcat -->
        <!-- BEGIN: hassubcat -->
        <a href="#" data-toggle="upcatload" data-catid="{CATID}" data-parentid="{CAT.id}" data-tokend="{NV_CHECK_SESSION}" title="{LANG.load_subcat}"><i class="fa fa-arrow-circle-right" aria-hidden="true"></i></a>
        <!-- END: hassubcat -->
    </div></li>
<!-- END: loop -->
<!-- END: cat -->
