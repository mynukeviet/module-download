...
<div class="block_download">
    ...
    <div class="pull-right">
        <div class="dropdown">
            <button class="btn btn-success dropdown-toggle btn-xs" type="button" id="dropdownMenu1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
                {LANG.onlineview} <span class="caret"></span>
            </button>
            <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                <!-- BEGIN: loop -->
                <li><a href="{SCORM_LINK}" target="_blank">{LANG.onlineview_path} {SCORM_NUM}</a></li>
                <!-- END: loop -->
            </ul>
        </div>
    </div>
    <!-- END: scorms -->
    <h1 class="m-bottom title">{ROW.title}</h1>
    <!-- BEGIN: addthis -->
    ...
    <div class="panel panel-default">
        <div class="panel-body">
            <!-- BEGIN: is_image -->
            <div class="image">
                <a href="#" id="pop" title="{ROW.title}"> <img id="imageresource" alt="{ROW.title}" src="{FILEIMAGE.src}" width="{FILEIMAGE.width}" height="{FILEIMAGE.height}" class="img-thumbnail">
                </a>
            ...
            <!-- END: is_image -->
            <div class="introtext m-bottom" id="download-bodyhtml">{ROW.description}</div>
        </div>
        <script>
    ...
    <div class="panel panel-default download">
        ...
        <div class="panel-heading">{LANG.download_fileupload} {SITE_NAME}:</div>
        <div class="panel-body">
            <!-- BEGIN: row -->
    ...
    <!-- BEGIN: linkdirect -->
    <div class="panel panel-default download">
        <div class="panel-heading">{LANG.download_linkdirect} {HOST}:</div>
        <div class="panel-body">
            <!-- BEGIN: row -->
    ...
    <!-- BEGIN: download_info -->
    <div class="download">
        <div class="alert alert-danger">{ROW.download_info}</div>
    </div>
    <!-- END: download_info -->
    <div class="panel panel-default">
        <div class="panel-heading">
        ...
        <div class="panel-body">
            ...
            <div style="padding: 5px;">
                <input class="hover-star" type="radio" value="1" title="{LANG.file_rating1}" style="vertical-align: middle" /> <input class="hover-star" type="radio" value="2" title="{LANG.file_rating2}" style="vertical-align: middle" /> <input class="hover-star" type="radio" value="3" title="{LANG.file_rating3}" style="vertical-align: middle" /> <input class="hover-star" type="radio" value="4" title="{LANG.file_rating4}" style="vertical-align: middle" /> <input class="hover-star" type="radio" value="5" title="{LANG.file_rating5}" style="vertical-align: middle" /> <span id="hover-test" style="margin-left: 20px">{LANG.file_rating_note}</span>
            </div>
        </div>
    </div>
    <!-- BEGIN: keywords -->
    ...
    <!-- BEGIN: comment -->
    <div class="panel panel-default">
        <div class="panel-body">{CONTENT_COMMENT}</div>
    </div>
    <!-- END: comment -->
</div>
<!-- END: main -->